...
export const metadata: Metadata = {
  title: "About",
  description:
    "Aetherion exists to understand, map, and build the technologies that will define the next century, focused on frontier science, strategic technology, and deep-tech intelligence.",
};
...
export default function AboutPage() {
  return (
    <>
      <PageHero
        eyebrow="About"
        title="Aetherion exists to understand, map, and build the technologies that will define the next century."
            ...
            <div className="lg:col-span-8 space-y-6 max-w-2xl">
              ...
              <Reveal delay={0.08}>
                <p className="text-base text-bone-dim leading-relaxed">
                  Aetherion was built on the premise that this gap — between
              ...
              <Reveal delay={0.14}>
                <p className="text-base text-bone-dim leading-relaxed">
                  Aetherion closes it. The firm operates across frontier
            ...
            <div className="lg:col-span-8 max-w-2xl">
              <Reveal>
                <p className="text-base md:text-lg text-bone-dim leading-relaxed">
                  Aetherion&apos;s work spans the full chain from discovery to
